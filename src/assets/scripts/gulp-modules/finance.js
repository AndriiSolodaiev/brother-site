...
class FinanceModule {
  constructor() {
    ...
    this.imageElement = document.querySelector('.finance-image');
    this.currentIndex = 0;
    ...
    this.categoryData = [
      ...
      },
      {
        ...
        image: '/wp-content/themes/3d/assets/images/pre-sales_assistance.png',
      },
      {
        title: 'Компенсація й винагороди затримки',
        description:
          'У випадку затримки введення будинку в експлуатацію клієнт отримує компенсацію вартості оренди приміщення аналогічної кімнатності з придбаним. Це покриває витрати на оренду під час очікування та забезпечує додаткову фінансову захищеність.',
        cards: [
          {
            title: 'Для кого',
            svg: this.svgs[0],
      ...
      },
      {
        ...
        image: '/wp-content/themes/3d/assets/images/possibility_of_changing_to_a_larger_area.png',
      },
      {
        title:
          'Допомога з продажем попередньої нерухомості та індивідуальний графік розтермінування (трейд-ін)',
        description:
          'Сервіс трейд-ін від РІЕЛ створений для інвесторів, які планують придбати нерухомість у наших проєктах і водночас продати свій попередній об’єкт. Він дозволяє зафіксувати вибране приміщення вже зараз і не втратити вигідні умови придбання через очікування продажу.',
        cards: [
          {
            title: 'Для кого',
            svg: this.svgs[0],
        ...
        image:
          '/wp-content/themes/3d/assets/images/assistance_with the_sale_of_previous_property.png',
      },
    ];
    ...
    this.categoryDataEnglish = [
      ...
      },
      {
        ...
        description:
          'In case of a delay in commissioning the building, the client receives compensation for the rental cost of a property with the same number of rooms as the one purchased. This covers rental expenses during the wait and provides additional financial security.',
        cards: [
          {
            title: 'Who is it for',
            svg: this.svgs[0],
      ...
      {
        title:
          'Assistance with Selling Previous Property and an Individual Installment Schedule (Trade-In)',
        description:
  ...
  updateContent(index) {
    ...
    while (existingCards.length < needed) {
      ...
      if (existingCards.length > 0) {
        ...
        const icon = toAppend.querySelector('.finance-card__icon');
        if (icon) icon.innerHTML = '';
        const title = toAppend.querySelector('.finance-card__title');
